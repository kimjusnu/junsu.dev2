...
const projects: Project[] = [
  {
    title: "마이피드 1.5/1.0",
    description: "에임비랩의 핵심 서비스. 마이피드 1.0 유지보수 및 1.5 버전 개발을 담당했습니다.",
  ...
  {
    title: "EatFit",
    description: "식습관 관리 앱. 사용자 식습관 데이터를 활용한 맞춤형 영양관리 서비스. PWA 형태로 개발했습니다.",
    ...
    <div className="relative w-full mt-16">
      ...
      <div className="flex justify-center gap-2 mb-6">
        {projects.map((_, index) => {
          ...
          const isVisible = 
            (index >= actualIndex && index < Math.min(endIndex, projects.length)) ||
      ...
      <div className="text-center mt-8 text-sm text-zinc-500">
        {(() => {
          ...
          if (endIndex > projects.length) {
            // [4, 5, 1] 같은 경우
            return `${actualIndex + 1}-${projects.length}, 1 / ${projects.length}`;
          }
